...
const listMusic = [
    { song: "Chúng Ta Sau Này", author: "T.R.I"},
    { song: "Nàng Thơ", author: "Hoàng Dũng"},
    { song: "Níu Duyên", author: "Lê Bảo Bình"},
    { song: "Tình Bạn Diệu Kỳ", author: "Amee"},
    { song: "31072", author: "Amee"},
    { song: "Cứ Thế Rời Xa", author: "Amee"},
    { song: "Đừng Xem Ai Đó Là Cả Thế Giới", author: "Amee"},
    { song: "Em Không Là Duy Nhất", author: "Amee"},
    { song: "Nhớ Người Hay Nhớ", author: "Amee"},
    { song: "Phải Chăng Em Đã Yêu", author: "Amee"},
    { song: "Thì Thôi", author: "Amee"},
    { song: "Trên Tình Bạn Dưới Tình Yêu", author: "Amee"},
    { song: "Vài Giây Nữa Thôi", author: "Amee"},
    { song: "Xa Một Trời Thương Nhớ", author: "Amee"}
];
class UI {
    constructor() {
      this.songIndex = 0;
